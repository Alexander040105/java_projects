 ...
 * @author 63947
 */
public class homeTrivQuestions extends javax.swing.JFrame {

    /**
     * Creates new form homeDOrD
     */
    public homeTrivQuestions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        gameDescrip.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/trivDescrip.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homeTrivQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new homeTrivQuestions().setVisible(true);
            }
        });
    }
